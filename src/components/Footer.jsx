        ...
        <section className="final-cta-section">
          <div className="final-cta-container">
            ...
            <p className="final-cta-links">
              <a href="#pricing" onClick={handleSectionLink('pricing')}>View pricing</a>
        ...
        <div className="footer-container">
          <div className="footer-column">
            ...
            <div className="social-icons">
              <a href="https://www.instagram.com/demadose/" className="social-icon" aria-label="DemaDose on Instagram">
              ...
              <a href="https://www.linkedin.com/company/demadose/posts/?feedView=all" className="social-icon" aria-label="DemaDose on LinkedIn">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              <li><a href="#pricing" onClick={handleSectionLink('pricing')}>Pricing</a></li>
